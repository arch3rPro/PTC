...
- **bantam** -  A PHP backdoor management and generation tool/C2 featuring end to end encrypted payload streaming designed to bypass WAF, IDS, SIEM systems.s
  - **文件Hash:** 6be7f1ab3f1920abda5519f509cc42c4d38dfaba766a6c457f613980fe738439

- **yujianportscan2020** -  一个基于VB.NET + IOCP模型开发的高效端口扫描工具，支持IP区间合并，端口区间合并，端口指纹深度探测
